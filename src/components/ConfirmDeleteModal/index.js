...
import { Container, TapClose, Title, Operators, CancelButton, ConfirmButton, TextButton } from './styles';
...
export function ConfirmDeleteModal({visible, setVisible}) {
    ...
    const userAreasToFor = useQuery(AreaSchema).filtered(`userId == '${user.id}'`).toJSON();
